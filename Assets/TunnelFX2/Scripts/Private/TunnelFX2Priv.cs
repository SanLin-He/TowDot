...
namespace TunnelEffect {
    ...
    public partial class TunnelFX2 : MonoBehaviour {
        ...
        static string[] textureNames = { "_TunnelTex1", "_TunnelTex2", "_TunnelTex3", "_TunnelTex4" };
        static string[] paramNames = { "_Params1", "_Params2", "_Params3", "_Params4" };
        ...
        void UpdateMaterialProperties(bool updateTunnelMesh = false) {
            ...
            if (updateTunnelMesh || !Application.isPlaying) {
